...
const Content = () => {
  ...
  const BookCard = ({ book, idx, delay = 0 }) => {
    return (
      <div 
        key={book.key || idx}
        className='w-[99%] h-[380px]order-amber-300 rounded-xl shadow-lg shadow-gray-500 flex flex-col justify-start items-center 
  ...
  return (
    <div className='w-full h-full flex flex-col justify-start items-center gap-[5%]'>
      ...
      <div className='w-full h-[950px] hidden md:flex flex-col justify-center items-center p-[10px]'>
      ...
      <div className='w-full h-[1400px] flex md:hidden flex-col justify-center items-center p-[10px]'>
        <div className='w-full h-[15%] flex flex-col justify-center items-center gap-2 opacity-0 animate-[fadeIn_0.8s_ease-out_0.2s_forwards]'>
          <div className='w-[99%] h-[48%] pl-2.5 flex justify-start items-center'>
